...
images1 = glob.glob('continuum/cameraCalibration/images/cam1/*.png')
images2 = glob.glob('continuum/cameraCalibration/images/cam2/*.png')
...
np.save('continuum/cameraCalibration/saveData/cam1/camera_matrix.npy', cameraMatrix1)
np.save('continuum/cameraCalibration/saveData/cam1/dist_coeffs.npy', dist1)
np.save('continuum/cameraCalibration/saveData/cam1/tvecs.npy', tvecs1)
np.save('continuum/cameraCalibration/saveData/cam1/rvecs.npy',rvecs1)

np.save('continuum/cameraCalibration/saveData/cam2/camera_matrix.npy', cameraMatrix2)
np.save('continuum/cameraCalibration/saveData/cam2/dist_coeffs.npy', dist2)
np.save('continuum/cameraCalibration/saveData/cam2/tvecs.npy', tvecs2)
np.save('continuum/cameraCalibration/saveData/cam2/rvecs',rvecs2)
